...
public:
  ...
  int image_stride_normal = 3;
  int image_stride_degenerate = 1;
  double keyframe_trans_thresh = 1.0;
  double keyframe_rot_thresh = 30.0;
  double keyframe_scale_min = 0.3;
  int img_counter = 0;
  StatesGroup last_keyframe_state_;
  bool has_keyframe_state_ = false;
  ...
  ofstream fout_pre, fout_out, fout_visual_pos, fout_lidar_pos, fout_points, fout_runtime_log;

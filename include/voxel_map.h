...
typedef struct VoxelMapConfig
{
  ...
  double degen_sigma_min_;
  double degen_valid_ratio_;
  double degen_avg_residual_;
  int degen_count_thresh_;
...
public:
  ...
  bool IsLidarDegenerate() const { return lidar_degenerate_; }

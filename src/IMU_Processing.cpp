...
// 【核心功能】初始化 IMU 处理器的状态与默认噪声参数
// 【输入/输出】输入: 无; 输出: 初始化成员变量与缓存
...
// 【核心功能】析构 IMU 处理器
// 【输入/输出】输入: 无; 输出: 由智能指针自动释放资源
ImuProcess::~ImuProcess() {}

// 【核心功能】重置 IMU 初始化状态与缓存
// 【输入/输出】输入: 无; 输出: 清空状态并重置统计量
...
// 【核心功能】设置激光雷达到 IMU 的外参矩阵
// 【输入/输出】输入: 4x4 位姿矩阵; 输出: 更新平移与旋转
...
// 【核心功能】设置 IMU 初始化所需帧数
// 【输入/输出】输入: 帧数阈值; 输出: 更新初始化计数上限
void ImuProcess::set_imu_init_frame_num(const int &num) { MAX_INI_COUNT = num; }

// 【核心功能】基于初始 IMU 数据估计重力与偏置
// 【输入/输出】输入: IMU 测量与状态引用; 输出: 更新状态与统计量
...
// 【核心功能】在禁用 IMU 时完成点云时间去畸变
// 【输入/输出】输入: 雷达测量与状态; 输出: 更新状态并输出点云
